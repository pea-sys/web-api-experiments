//https://docs.microsoft.com/ja-jp/troubleshoot/windows/win32/use-dnsquery-resolve-host-names
//ipconfig/allで得たホスト名とDNSサーバのIPアドレスを起動引数として与えて名前解決を行う
...
void __cdecl main(int argc, char* argv[])
{
    ...
    status = DnsQuery(convertCharArrayToLPCWSTR(pOwnerName), //Pointer to OwnerName. 
